	...
	<div class="container">
		<div class="row">
      		<div class="col-md-6">
		        <div class="post">
		          ...
		          <h2 class="post-title"><a href="blog-single.jsp">How To Wear Bright Shoes</a></h2>
		          <div class="post-meta">
		            <ul>
		              <li>
		              ...
		              <li>
		                <a href="blog-grid.jsp"><i class="tf-ion-ios-pricetags"></i> LIFESTYLE</a>,<a href="blog-grid.jsp"> TRAVEL</a>, <a
		                href="blog-grid.jsp">FASHION</a>
		              </li>
		              <li>
		          ...
		          <div class="post-content">
		            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit vitae placeat ad architecto nostrum
		              ...
		              elit. Quod, facere. </p>
		            <a href="blog-single.jsp" class="btn btn-main">Continue Reading</a>
		          </div>
				</div>
        	</div>
			<div class="col-md-6">
	          ...
	          <h2 class="post-title"><a href="blog-single.jsp">Two Ways To Wear Straight Shoes</a></h2>
	          <div class="post-meta">
	            <ul>
	              <li>
	                <i class="tf-ion-ios-calendar"></i> 20, MAR 2017
	              ...
	              <li>
	                <a href="blog-left-sidebar.jsp"><i class="tf-ion-ios-pricetags"></i> LIFESTYLE</a>,<a href="blog-left-sidebar.jsp"> TRAVEL</a>, <a
	                href="blog-left-sidebar.jsp">FASHION</a>
	              </li>
	              <li>
	                <a href="#!"><i class="tf-ion-chatbubbles"></i> 4 COMMENTS</a>
	              </li>
      		...
      		<div class="col-md-6">
				<div class="post">
					...
					<h2 class="post-title"><a href="blog-single.jsp">Making A Denim Statement</a></h2>
					<div class="post-meta">
						<ul>
							<li>
								<i class="tf-ion-ios-calendar"></i> 20, MAR 2017
							...
							<li>
								<a href="blog-right-sidebar.jsp"><i class="tf-ion-ios-pricetags"></i> LIFESTYLE</a>,<a href="blog-right-sidebar.jsp"> TRAVEL</a>, <a href="blog-right-sidebar.jsp">FASHION</a>
							</li>
							<li>
								<a href="#!"><i class="tf-ion-chatbubbles"></i> 4 COMMENTS</a>
							</li>
			...
			<div class="col-md-6">
				<div class="post">
					...
					<h2 class="post-title"><a href="blog-single.jsp">Standard Text Post</a></h2>
					<div class="post-meta">
						<ul>
							<li>
								<i class="tf-ion-ios-calendar"></i> 20, MAR 2017
							...
							<li>
								<a href="blog-full-width.jsp"><i class="tf-ion-ios-pricetags"></i> LIFESTYLE</a>,<a href="blog-full-width.jsp"> TRAVEL</a>, <a href="blog-full-width.jsp">FASHION</a>
							</li>
							<li>
								<a href="#!"><i class="tf-ion-chatbubbles"></i> 4 COMMENTS</a>
							</li>
			...
			<div class="col-md-6">
				<div class="post">
					...
					<h2 class="post-title"><a href="blog-single.jsp">Standard Audio Post</a></h2>
					<div class="post-meta">
						<ul>
							<li>
								<i class="tf-ion-ios-calendar"></i> 20, MAR 2017
			...
			<div class="col-md-6">
				<div class="post">
					...
					<h2 class="post-title"><a href="blog-single.jsp">Standard Video Post</a></h2>
					<div class="post-meta">
						<ul>
							<li>
								<i class="tf-ion-ios-calendar"></i> 20, MAR 2017
		...
		<div class="text-center">
			<ul class="pagination post-pagination">
				<li><a href="blog-left-sidebar.jsp">Prev</a>
				</li>
				<li class="active"><a href="blog-left-sidebar.jsp">1</a>
				</li>
				<li><a href="blog-left-sidebar.jsp">2</a>
				</li>
				<li><a href="blog-left-sidebar.jsp">3</a>
				</li>
				<li><a href="blog-left-sidebar.jsp">4</a>
				</li>
				<li><a href="blog-left-sidebar.jsp">5</a>
				</li>
				<li><a href="blog-left-sidebar.jsp">Next</a>
				</li>
			</ul>
		</div>
  </div>
